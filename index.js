document.querySelector('.gallery-images-present').addEventListener('click',function(){
            window.location.href = "elpresente.html"; 
})
...
document.querySelector('.gallery-images-futur').addEventListener('click',function(){
            window.location.href = "elfuturo.html"; 
})
